...
const About = () => {
  return (
    <div className='aboutbox'>
        <div className='left'>
          <p className='p1'>I'm <span className='span1'>Tarun Gupta</span>,<br/>A Software Developer<br/><span className='span2'>in development</span></p>
          ...
          <p className='p3'>My goal is to make a living out of developing random things and learn some more skills. I also <a href='https://www.upwork.com/freelancers/~01993e267b8aac12fd' target='_blank' rel="noreferrer">Freelance</a>.</p>
        </div>
        <div className='right'>
