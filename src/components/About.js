...
const About = () => {
  return (
    <div className='aboutbox'>
        <div className='left'>
          <motion.p className='p1' initial={{scale:0.8}} whileInView={{scale:1}} transition={{duration:0}}>I'm <span className='span1'>Tarun Gupta</span>,<br/>A Developer<br/><span className='span2'>in development</span></motion.p>
